#!/bin/bash
# Cbox Base Images - Multi-Variant E2E Test Runner
...
# Configuration
REGISTRY="${REGISTRY:-ghcr.io/cboxdk/php-baseimages}"
...
usage() {
    ...
    echo "  REGISTRY=ghcr.io/cboxdk/php-baseimages   Image registry"
...
log_section "Cbox Multi-Variant E2E Test Suite"
echo ""
