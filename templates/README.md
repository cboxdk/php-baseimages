...
**Staging:**
```dockerfile
FROM ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1 AS staging
...
**Production:**
```dockerfile
FROM ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1 AS production
