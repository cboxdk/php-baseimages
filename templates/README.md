...
**Staging:**
```dockerfile
FROM ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.4-bookworm-v1 AS staging
...
**Production:**
```dockerfile
FROM ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.4-bookworm-v1 AS production
...
### Production
- ✅ Use base Cbox images (no dev tools)
