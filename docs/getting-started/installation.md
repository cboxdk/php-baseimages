...
# Verify installation
docker run --rm ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1 php -v
```
...
```bash
# PHP-FPM only
ghcr.io/cboxdk/php-baseimages/php-fpm:8.5-bookworm-v1

# PHP CLI only
ghcr.io/cboxdk/php-baseimages/php-cli:8.5-bookworm-v1
...
```bash
php-fpm-nginx:8.5-bookworm       # Latest 8.4 (standard tier)
php-fpm-nginx:8.5-bookworm-slim  # Latest 8.4 (slim tier)
```
...
```bash
php-fpm-nginx:8.5-bookworm-sha256:abc123...
```
...
# Specific extension
docker run --rm ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1 php -m | grep redis
```
...
```bash
# Start container
docker run -d --name test ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1
...
docker pull --platform linux/amd64 ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1
```
