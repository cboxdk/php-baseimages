...
|-------|-------|-------|------------|
| php-fpm-nginx:8.5-bookworm-slim | ~120 MiB | ~115 MiB | ARM64 slightly smaller |
| php-fpm-nginx:8.5-bookworm | ~250 MiB | ~240 MiB | ARM64 slightly smaller |
| php-fpm-nginx:8.5-bookworm-chromium | ~700 MiB | ~680 MiB | ARM64 slightly smaller |
| php-fpm-nginx:8.5-bookworm-dev | ~750 MiB | ~730 MiB | ARM64 slightly smaller |
...
docker run --rm ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1 uname -m
...
docker pull --platform linux/arm64 ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.5-bookworm-v1
```
