...
```bash
# Cbox version
docker inspect ghcr.io/cboxdk/php-baseimages/php-fpm-nginx:8.3-bookworm-v1 | grep Created
...
- **Bug Reports**: [GitHub Issues](https://github.com/cboxdk/php-baseimages/issues) (label: bug)
...
**Can't find what you're looking for?** Ask in [GitHub Discussions](https://github.com/cboxdk/php-baseimages/discussions).
