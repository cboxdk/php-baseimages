...
Need more automation? Combine this with the [Production Deployment](../guides/production-deployment) checklist to promote healthy builds straight into staging.
