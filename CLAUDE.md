...
# PHP-FPM Metrics Exporter (cboxdk/fpm-exporter; off by default)
CBOX_FPM_EXPORTER=true            # phpfpm_* + laravel_* metrics on :9114 - the horizontal-scaling signals (listen_queue, worker saturation)
